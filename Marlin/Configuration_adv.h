...
#define FWRETRACT  // ONLY PARTIALLY TESTED
  ...
  #define RETRACT_RECOVER_LENGTH_SWAP 13   // Default additional swap recover length (mm, added to retract length when recovering from extruder change)
  #define RETRACT_RECOVER_FEEDRATE 70      // Default feedrate for recovering from retraction (mm/s)
  #define RETRACT_RECOVER_FEEDRATE_SWAP 70 // Default feedrate for recovering from swap retraction (mm/s)
#endif
